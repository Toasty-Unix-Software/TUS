...
/* CPUID.01H:EDX.APIC (bit 9): true on every x86-64 CPU that has ever
 * shipped in practice, but pic_init() checks anyway rather than
 * assuming it before touching the Local APIC's MSR. */
